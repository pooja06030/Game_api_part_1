...
class GameMaker(models.Model):
    ...
    developer = models.ForeignKey(Developer,on_delete=models.CASCADE,default=1)
    game_name = models.CharField(max_length=100)
    game_price = models.DecimalField( max_digits=10,decimal_places=2, default=0.00)
    game_type = models.CharField(max_length=10, choices=GAME_TYPE_CHOICES, default='HTML')
...
#    device = models.ForeignKey(device_frant, on_delete=models.CASCADE, default=1)
